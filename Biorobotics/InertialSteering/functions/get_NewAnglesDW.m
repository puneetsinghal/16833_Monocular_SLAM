function [angles_array,mainAxis,currSerpPos,shapeRegularity] = get_NewAnglesDW(snakeCompl, snakeConst, windows, t)
...
%             angle0      = angle0 * cos(torsionNew);
            ...
            angle = dAmp * sin(norm * dSpFreq - t + pi/2);
%             angle = angle * sin(torsionNew);
