...
% Oct 2013
    ...
    reversals = [];
    for reversal=1:ceil(numModules/2)
        negOrPos = mod(reversal,2)*2-1;
        reversals = [reversals,negOrPos,negOrPos];
    end
    
    snakeData.reversals = reversals(1:numModules);
    
    snakeData.x_ang_mask = snakeData.x_ang_mask;
    snakeData.y_ang_mask = snakeData.y_ang_mask;
